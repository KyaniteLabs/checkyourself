# ROLE: LUNA FIX TEAM — WAVE 2 (checkyourself)
Read _retrofit-2026-09-04/MASTER-REGISTER.md. Execute WAVE 2 ONLY (W1 done: MR-001 landed).
...
- Acceptance: run the register's W2 acceptance commands; then python3 -m pytest tests/ -q.
