...
- Project:
- Score before fixes:
- Score after fixes, if applicable:
- Main risk pattern:
...
| Term | Plain-English meaning | Where it appeared |
|---|---|---|

## Do not learn this yet

These are valid topics, but they are not the next bottleneck for this project.

| Topic | Why later |
|---|---|

## Next CheckYourself run

Run another diagnostic after:

- [ ] P0 findings are fixed.
- [ ] P1 findings are fixed.
- [ ] The first 7-day learning plan is complete.
- [ ] A deployment/rollback path is documented.
